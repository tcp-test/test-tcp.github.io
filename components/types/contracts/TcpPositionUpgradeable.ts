...
export interface TcpPositionUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_assessLevel"
      | "_cycleTime"
...
export interface TcpPositionUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): TcpPositionUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: TcpPositionUpgradeableInterface;
  ...
  initialize: TypedContractMethod<
    [dataToChainAddress: AddressLike, token: AddressLike],
    [void],
    "nonpayable"
  >;
